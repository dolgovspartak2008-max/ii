            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        " Не называй цены, скидки, акции, условия или список товаров, "
                        "если клиент прямо не спросил о товаре, цене, скидке, "
                        "акции или составе предложения. Не повторяй цены, которые уже "
                        "названы, без прямого запроса клиента. Никогда не выводи "
                        "служебные статусы User Safety, safe или unsafe: это не ответ "
                        "для клиента."
                    ),
                },
